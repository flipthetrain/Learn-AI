...
csv_path = os.path.join(csv_dir, 'aws_bedrock_example.csv')
plot_dir = os.path.join(os.path.dirname(__file__), 'plot')
os.makedirs(plot_dir, exist_ok=True)
plot_path = os.path.join(plot_dir, 'aws_bedrock_example.png')
...
plt.title('aws_bedrock_example Embeddings (PCA)')
plt.xlabel('PC1')
plt.ylabel('PC2')
plt.tight_layout()
