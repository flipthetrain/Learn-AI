...
try:
    ...
    # Anthropic does not expose a standalone embeddings API; use sentence-transformers locally
    # for retrieval, then pass context to Claude for generation.
    ...
    for question in QUESTIONS:
        ...
        # --- GENERATE: ask Claude with retrieved context ---
        context = "\n\n".join(context_parts)
